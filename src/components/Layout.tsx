...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Maintenance', href: '/maintenance', icon: ClipboardList },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-10 bg-black bg-opacity-50" onClick={() => setMobileMenuOpen(false)}>
      ...
      {/* Main content */}
      <div className={cn(
        "min-h-screen pt-16 lg:pt-0 lg:pl-64",
      )}>
